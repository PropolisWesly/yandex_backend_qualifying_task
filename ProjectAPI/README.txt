...
по адресу 0.0.0.0:80. Подробнее о реализованных запросах можно найти в openapi.yaml.
...
при обращении к БД) это исправляется без особых изменений кода.
    ...
    Для тестирования использовался предоставленный модуль unit_test.py и ручная проверка на стадии написания кода.
